...
Response.prototype.removeCookie = function (cookieName) {
    ...
    cookies.splice(i, 1);
    this.headers.getHeader("set-cookie", cookies, true);
    return true;
};
...
Response.prototype.isCachingDisabled = function () {
    ...
    cachingDisabled = cachingDisabled || (pragma && pragma.search('no-cache') > -1);
    cachingDisabled = cachingDisabled || (cacheControl && cacheControl.search('no-cache') > -1);
    cachingDisabled = cachingDisabled || (cacheControl && cacheControl.search('private') > -1);
...
Response.prototype.getCacheTimeInSeconds = function () {
    ...
    var pragma = this.getHeader('pragma');
    if (pragma && pragma.search('no-cache') > -1) {
        return 0;
    }
