...
S3Client.prototype.get = function (key, callback) {
    this._spawnFunction(this._get.bind(this, key), callback);
};
...
S3Client.prototype.getAcl = function (key, callback) {
    key = key + '?acl';
    this._spawnFunction(this._get.bind(this, key), function (err, response) {
        if (err) {
 ...
 * @param {function} callback
 */
S3Client.prototype._get = function (key, callback) {
    var request = this._client.get(key);
    if (this.timeout) {
        request.setTimeout(this.timeout);
    }
    request.on('response', this._handleResponse.bind(this, callback));
